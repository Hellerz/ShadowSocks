namespace Shadowsocks.Model
{
    ...
    public class Configuration
    {
        ...
        public static Configuration Load()
        {
            try
            {
                Configuration configuration = SimpleJson.DeserializeObject<Configuration>(File.ReadAllText(CONFIG_FILE), new JsonSerializerStrategy());
        ...
        public static void Save(Configuration config)
        {
            ...
            try
            {
                ...
                {
                    string str = SimpleJson.SerializeObject(config);
                    writer.Write(str);
                    writer.Flush();
                }
            }
