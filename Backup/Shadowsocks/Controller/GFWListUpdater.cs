namespace Shadowsocks.Controller
{
    ...
    public class GFWListUpdater
    {
        ...
        private EventHandler<ResultEventArgs> UpdateCompleted;
        ...
        private void http_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            try
            {
                ...
                string contents = Utils.UnGzip(Resources.abp_js).Replace("__RULES__", SimpleJson.SimpleJson.SerializeObject(json));
