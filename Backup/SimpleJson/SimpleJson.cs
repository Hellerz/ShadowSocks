namespace SimpleJson
{
    ...
    public class SimpleJson
    {
        ...
        private static SimpleJson.PocoJsonSerializerStrategy pocoJsonSerializerStrategy;
        ...
        public static IJsonSerializerStrategy CurrentJsonSerializerStrategy
        {
            get
            {
                if (SimpleJson.SimpleJson.currentJsonSerializerStrategy == null)
                {
                    IJsonSerializerStrategy currentJsonSerializerStrategy = SimpleJson.SimpleJson.currentJsonSerializerStrategy;
                }
                return (SimpleJson.SimpleJson.currentJsonSerializerStrategy = PocoJsonSerializerStrategy);
            }
            set
            {
        ...
        public static SimpleJson.PocoJsonSerializerStrategy PocoJsonSerializerStrategy
        {
            get
            {
                if (SimpleJson.SimpleJson.pocoJsonSerializerStrategy == null)
                {
                    SimpleJson.PocoJsonSerializerStrategy pocoJsonSerializerStrategy = SimpleJson.SimpleJson.pocoJsonSerializerStrategy;
                }
                return (SimpleJson.SimpleJson.pocoJsonSerializerStrategy = new SimpleJson.PocoJsonSerializerStrategy());
            }
        }
    }
}
